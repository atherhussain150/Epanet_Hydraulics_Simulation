...
// 'http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/e3f13720-de48-11eb-8f90-0f87b550f6c6/values/timeseries'
function GetTelemertryData(Token) {
  axios.get('http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/39805350-7da1-11eb-81e7-7bf4b1b85926/values/timeseries',
...
function send2Thingsboard(pValue) {
  const thingsboardHost = "iot4h2o.mv.uni-kl.de";
  const ACCESS_TOKEN = "G29T3syyuXIDT0nxID96";
...
async function WT_Hatzenbühl_data(Token) {
  var resp_val;
  await axios.get('http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/39805350-7da1-11eb-81e7-7bf4b1b85926/values/timeseries',
    { headers: { "X-Authorization": `Bearer ${Token}`, "Content-Type": "application/json" } }
  ).then(response => {
...
async function WT_Rulzheim_data(Token) {
  var resp_val;
  await axios.get('http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/308325c0-7da1-11eb-81e7-7bf4b1b85926/values/timeseries',
    { headers: { "X-Authorization": `Bearer ${Token}`, "Content-Type": "application/json" } }
  ).then(function (response) {
...
async function WT_Worth_data(Token) {
  var resp_val;
  await axios.get('http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/260db010-7da1-11eb-81e7-7bf4b1b85926/values/timeseries',
    { headers: { "X-Authorization": `Bearer ${Token}`, "Content-Type": "application/json" } }
  ).then(function (response) {
...
async function Wasserwerk_Jockgirm_data(Token) {
  var resp_val;
  await axios.get('http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/47a69c00-7da1-11eb-81e7-7bf4b1b85926/values/timeseries',
    { headers: { "X-Authorization": `Bearer ${Token}`, "Content-Type": "application/json" } }
  ).then(function (response) {
...
async function Wasserwerk_Kuhardt_data(Token) {
  var resp_val;
  await axios.get('http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/5124b960-7da1-11eb-81e7-7bf4b1b85926/values/timeseries',
    { headers: { "X-Authorization": `Bearer ${Token}`, "Content-Type": "application/json" } }
  ).then(function (response) {
...
async function DEA_Knittelsheim_data(Token) {
  var resp_val;
  await axios.get('http://iot4h2o.mv.uni-kl.de:8080/api/plugins/telemetry/DEVICE/5d4e7e30-f423-11eb-88d0-df9159a9b3d4/values/timeseries',
    { headers: { "X-Authorization": `Bearer ${Token}`, "Content-Type": "application/json" } }
  ).then(function (response) {
...
function SubscribedDevices() {
  ...
  // Water Tower devices
  const WT_Hatzenbühl = "jyXElnKaavP63hOF4k6K";  //n9IqRbv633DvwV8j6Zqb
  const WT_Rülzheim = "8s7KqLd4jzIeGbblEauO";
  const WT_Wörth = "aKhhW6x92cFFEXybMFfa";

  //Water Plant devices
  const Wasserwerk_Jockgirm = "VaHJOZvERK3iebpkilwT";
  const Wasserwerk_Kuhardt = "uRdOU74bNrwob2wJt6aR";

  // DEA Plant
  const DEA_Knittelsheim = "XoQ3yRVkWCmsDRqIyhuE";
